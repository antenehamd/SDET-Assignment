...
<xsl:template match="testResults">
	<html>
		<head>
			...
			<script language="JavaScript"><![CDATA[
			   ...
			   function change(details_id)
			   {
			      ...
			      {
			         document.getElementById(details_id+"_image").src = "JmeterReport/collapse.png";
			         expand(details_id);
			      }
			      else
			      {
			         document.getElementById(details_id+"_image").src = "JmeterReport/expand.png";
			         collapse(details_id);
			      } 
                           }
			]]></script>
		...
		<body>
			...
			<xsl:call-template name="TestCaseSummary" />
...
<xsl:template name="TestCaseSummary">
<h2>Glossary</h2>
	<table align="center" class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
		<tr valign="top">
			<td>TC1-GoogleAPI-ListElections</td>
			<td>Assert ElectionDate,200 OK,Name In response</td>
		</tr>
		<tr valign="top">
			<td>TC2-GoogleAPI-ListElections-PrettyPrint</td>
			<td>Verify response with pretty print param</td>
		</tr>
		<tr valign="top">
			<td>TC3-GoogleAPI-ListElections-InvalidRequest</td>
			<td>Verify that invalid request fails</td>
		</tr>
		<tr valign="top">
			<td>TC4-GoogleAPI-Representatives-GetOcdInfo</td>
			<td>Check a random ocd (can select all also) info with all combination of government</td>
		</tr>
	</table>
</xsl:template>	
			...
			<tr valign="top">
				...
				<td align="center">
				   <a href="">
				      ...
				      <img src="JmeterReport/expand.png" alt="expand/collapse"><xsl:attribute name="id"><xsl:text/>page_details_<xsl:value-of select="position()" />_image</xsl:attribute></img>				      
				   </a>
				</td>
			</tr>
